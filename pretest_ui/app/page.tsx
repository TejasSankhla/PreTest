          ...
          <div className="container flex flex-col  items-center justify-center mx-auto px-4 md:px-6">
            ...
            <div className="flex flex-col w-full sm:flex-row sm:justify-center  gap-4 mb-8">
              <Button asChild className="p-4 shadow-2xl" variant="outline">
                <Link href="/search">Book a free trial</Link>
              </Button>
              <Button
                asChild
                className=" bg-gray-900 text-white p-4  shadow-2xl"
              >
                <Link href="/search">Find your mentor</Link>
              </Button>
            </div>
            {/* // features  */}
            ...
            <div className="feature mt-8 py-4 w-full text-ce ">
              <div className="mx-auto max-w-7xl mt-8 px-2 my-4 lg:px-8">
                ...
                <div className="mt-8  grid grid-cols-1 items-center gap-6 md:grid-cols-2 ">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-5">
                      ...
                      <p className="mt-3 text-base text-gray-600">
                        Schedule your mock interview and receive expert
                        feedback.
                      </p>
                    </div>
                  </div>
              ...
              <div className="cursor-pointer rounded-md border border-gray-400 shadow-lg transition-all duration-200">
                ...
                <div className="px-4 pb-5 sm:px-6 sm:pb-6">
                  <p className="text-gray-500">
                    Pretest is a free platform that connects students with
                    mentors from top colleges and industries to prepare for mock
                    interviews and peer learning sessions. Whether you're
                    looking to polish your interview skills or learn from peers,
                    Pretest provides a supportive environment to help you
                    succeed.
                  </p>
                </div>
              </div>
              ...
              <div className="cursor-pointer rounded-md border border-gray-400 shadow-lg transition-all duration-200">
                ...
                <div className="px-4 pb-5 sm:px-6 sm:pb-6">
                  <p className="text-gray-500">
                    ...
                    working professionals. You can book an appointment by
                    browsing available mentors, selecting a time that fits your
                    schedule, and receiving your meeting details via email.
                  </p>
                </div>
              </div>
              {/* 3 faq */}
