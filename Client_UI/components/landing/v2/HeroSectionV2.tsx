...
export default function HeroSectionV2() {
  return (
    <section className="min-h-screen flex overflow-hidden bg-white w-full pt-14 relative items-center justify-center">
      {/* Background Elements */}
      <div
      ...
      <div className="relative w-full max-w-screen-xl mx-auto px-6 grid lg:grid-cols-2 gap-12 lg:gap-20 items-center h-full py-12 lg:py-0">
        {/* Hero Content */}
        <motion.div
        ...
        >
          ...
          <motion.h1
            variants={fadeInUp}
            className="text-5xl sm:text-6xl lg:text-[5.5rem] font-bold tracking-tighter text-gray-900 leading-[0.95] mb-8"
          ...
          <motion.p
            variants={fadeInUp}
            className="text-lg sm:text-xl text-gray-500 mb-10 max-w-lg leading-relaxed font-medium tracking-tight"
          >
          ...
          >
            ...
            <button className="bg-white border border-gray-200 text-gray-600 hover:text-gray-900 hover:border-gray-300 text-sm font-semibold px-6 py-3.5 rounded-full transition-all flex items-center justify-center">
              View Sample Report
            </button>
          </motion.div>
        ...
        <div className="relative h-full min-h-[600px] w-full hidden lg:flex items-center justify-center">
          ...
          <div className="relative w-[420px] h-[420px]">
            {/* Core */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 bg-white rounded-full shadow-[0_4px_30px_rgba(0,0,0,0.08)] border border-gray-100 flex items-center justify-center z-20">
            ...
            >
              <div className="absolute -top-2.5 left-1/2 -translate-x-1/2 w-8 h-8 bg-white rounded-full shadow-md border border-gray-100 flex items-center justify-center animate-counter-rotate-fast">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-blue-500">
                  <path d="m5 12 7-7 7 7" />
                  <path d="M12 19V5" />
                </svg>
              </div>
              <div className="absolute -bottom-2.5 left-1/2 -translate-x-1/2 w-8 h-8 bg-white rounded-full shadow-md border border-gray-100 flex items-center justify-center animate-counter-rotate-fast">
            ...
            {/* Orbit Ring 2 - Outer */}
            <div
              className="absolute top-1/2 left-1/2 w-[320px] h-[320px] rounded-full border border-gray-100/80 animate-orbit-slow z-0"
            ...
            >
              ...
              <div className="absolute top-[45%] left-[-16px] w-10 h-10 bg-white rounded-xl shadow-md border border-gray-100 flex items-center justify-center animate-counter-rotate-slow">
                <span className="font-bold text-[10px] tracking-tight text-gray-800">Amz</span>
              </div>
              <div className="absolute bottom-[5%] right-[20%] w-10 h-10 bg-white rounded-xl shadow-md border border-gray-100 flex items-center justify-center animate-counter-rotate-slow">
                <span className="font-bold text-[10px] tracking-tight text-gray-800">Fk</span>
              </div>
            </div>

            {/* Floating Card 1 - Offer Received (Top Right) */}
            <motion.div
              className="absolute -right-16 top-4 bg-white/95 backdrop-blur-sm p-3 rounded-xl border border-gray-100 shadow-[0_8px_30px_rgba(0,0,0,0.1)] w-44 z-30"
              animate={{ y: [0, -8, 0] }}
            ...
            >
              <div className="flex items-center gap-2.5 mb-2">
                ...
                <div>
                  <div className="text-[11px] font-semibold text-gray-900">Offer Received</div>
                  <div className="text-[9px] text-gray-500">Google L3</div>
                </div>
              </div>
            ...
            <motion.div
              className="absolute -left-20 bottom-8 bg-white/95 backdrop-blur-sm p-3.5 rounded-xl border border-gray-100 shadow-[0_8px_30px_rgba(0,0,0,0.1)] w-56 z-30"
              animate={{ y: [0, -8, 0] }}
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[9px] text-green-600 font-semibold">9.0</span>
                  </div>
                </div>
                {/* Problem Solving */}
                <div className="flex items-center justify-between">
                  <span className="text-[10px] text-gray-500 font-medium">Problem Solving</span>
                  <div className="flex items-center gap-1.5">
                    <div className="w-16 h-1 bg-gray-100 rounded-full overflow-hidden">
                ...
                {/* Communication */}
                <div className="flex items-center justify-between">
                  <span className="text-[10px] text-gray-500 font-medium">Communication</span>
                  <div className="flex items-center gap-1.5">
                    <div className="w-16 h-1 bg-gray-100 rounded-full overflow-hidden">
                      <div className="h-full w-[85%] bg-blue-500 rounded-full" />
                    </div>
                    <span className="text-[9px] text-blue-600 font-semibold">8.5</span>
                  </div>
                </div>
                {/* Projects */}
                <div className="flex items-center justify-between">
                ...
                {/* Code Quality */}
                <div className="flex items-center justify-between">
                  <span className="text-[10px] text-gray-500 font-medium">Code Quality</span>
                  <div className="flex items-center gap-1.5">
                    <div className="w-16 h-1 bg-gray-100 rounded-full overflow-hidden">
