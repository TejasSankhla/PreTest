    ...
    <section className="py-32 bg-background">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <motion.h2
            variants={fadeInUp}
            className="text-3xl md:text-5xl font-bold tracking-tighter tracking-tight-v2 text-text-primary mb-6"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-6 md:grid-rows-2 gap-5 h-auto md:h-[600px]">
          ...
          <motion.div
            className="md:col-span-2 md:row-span-1 bg-background-subtle rounded-3xl p-8 border border-border flex flex-col justify-between overflow-hidden group hover:border-border transition-all relative"
          ...
          >
            <div className="relative z-10">
              <div className="w-10 h-10 bg-background rounded-lg flex items-center justify-center text-secondary shadow-sm border border-border mb-4">
            ...
            <div className="mt-8 bg-background rounded-xl border border-border p-3 shadow-sm opacity-80 scale-100 group-hover:scale-105 transition-transform origin-bottom-left">
              <div className="flex gap-2 items-center mb-2">
                <div className="w-6 h-6 rounded-full bg-border" />
                <div className="h-2 w-20 bg-border rounded-full" />
              </div>
              <div className="h-2 w-full bg-background-subtle rounded-full mb-1" />
              <div className="h-2 w-2/3 bg-background-subtle rounded-full" />
            </div>
          </motion.div>

          {/* Card 2: Select Mentor (Large/Wide) */}
          <motion.div
            className="md:col-span-4 md:row-span-1 bg-background-subtle rounded-3xl p-8 border border-border relative overflow-hidden group hover:border-border transition-all flex flex-col md:flex-row gap-6"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <div className="md:w-1/2 relative">
              <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-t from-background-subtle to-transparent z-10 md:hidden" />
